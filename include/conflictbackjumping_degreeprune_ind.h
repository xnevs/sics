#ifndef GMCS_CONFLICTBACKJUMPING_DEGREEPRUNE_IND_H_
#define GMCS_CONFLICTBACKJUMPING_DEGREEPRUNE_IND_H_
...
void conflictbackjumping_degreeprune_ind(
    G const & g,
    H const & h,
...
#endif  // GMCS_CONFLICTBACKJUMPING_DEGREEPRUE_IND_H_
