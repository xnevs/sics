#ifndef GMCS_BACKTRACKING_PARENT_DEGREEPRUNE_IND_H_
#define GMCS_BACKTRACKING_PARENT_DEGREEPRUNE_IND_H_
...
void backtracking_parent_degreeprune_ind(
    G const & g,
    H const & h,
...
#endif  // GMCS_BACKTRACKING_PARENT_DEGREEPRUNE_IND_H_
