#ifndef GMCS_LAZYFORWARDCHECKING_LOW_DEGREEPRUNE_IND_H_
#define GMCS_LAZYFORWARDCHECKING_LOW_DEGREEPRUNE_IND_H_
...
#endif  // GMCS_LAZYFORWARDCHECKING_LOW_DEGREEPRUNE_IND_H_
