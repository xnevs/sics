#ifndef SICS_LAZYFORWARDCHECKING_PARENT_DEGREEPRUNE_IND_H_
#define SICS_LAZYFORWARDCHECKING_PARENT_DEGREEPRUNE_IND_H_
...
#endif  // SICS_LAZYFORWARDCHECKING_PARENT_DEGREEPRUNE_IND_H_
