#ifndef SICS_BACKTRACKING_DEGREEPRUNE_ADJACENTCONSISTENCY_IND_H_
#define SICS_BACKTRACKING_DEGREEPRUNE_ADJACENTCONSISTENCY_IND_H_
...
#endif  // SICS_BACKTRACKING_DEGREEPRUNE_ADJACENT_CONSISTENCY_IND_H_
