#ifndef SICS_BACKTRACKING_ADJACENTCONSISTENCY_FORWARDCOUNT_IND_H_
#define SICS_BACKTRACKING_ADJACENTCONSISTENCY_FORWARDCOUNT_IND_H_
...
#endif  // SICS_BACKTRACKING_ADJACENTCONSISTENCY_FORWARDCOUNT_IND_H_
