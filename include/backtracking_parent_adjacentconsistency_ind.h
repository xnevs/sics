#ifndef SICS_BACKTRACKING_PARENT_ADJACENTCONSISTENCY_IND_H_
#define SICS_BACKTRACKING_PARENT_ADJACENTCONSISTENCY_IND_H_
...
#endif  // SICS_BACKTRACKING_PARENT_ADJACENTCONSISTENCY_IND_H_
