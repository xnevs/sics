#ifndef GMCS_BACKTRACKING_PARENT_DEGREEPRUNE_ADJACENTCONSISTENCY_BACKWARDCOUNT_IND_H_
#define GMCS_BACKTRACKING_PARENT_DEGREEPRUNE_ADJACENTCONSISTENCY_BACKWARDCOUNT_IND_H_
...
template <
    ...
    typename Callback>
void backtracking_parent_degreeprune_adjacentconsistency_backwardcount_ind(
    G const & g,
    H const & h,
