#ifndef SICS_BACKJUMPING_DEGREEPRUNE_IND_H_
#define SICS_BACKJUMPING_DEGREEPRUNE_IND_H_
...
void backjumping_degreeprune_ind(
    G const & g,
    H const & h,
...
#endif  // SICS_BACKJUMPING_DEGREEPRUNE_IND_H_
