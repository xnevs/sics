#ifndef SICS_BACKTRACKING_PARENT_FORWARDCOUNT_IND_H_
#define SICS_BACKTRACKING_PARENT_FORWARDCOUNT_IND_H_
...
void backtracking_parent_forwardcount_ind(
    G const & g,
    H const & h,
...
#endif  // SICS_BACKTRACKING_PARENT_FORWARDCOUNT_IND_H_
